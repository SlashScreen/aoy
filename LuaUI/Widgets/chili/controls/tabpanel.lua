...
--- @field tabs table<string, table> A table containing the tabs in the tab panel. Each tab has a `name` (string) and a `children` field (table of Controls).
--- @field currentTab Control The currently visible tab.
