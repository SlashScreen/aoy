...
--- @class DetachableTabPanel : LayoutPanel
--- @field tabs table<string, Control> Tabs contained in the tab panel. Each tab has a `.name` (string) and a `.children` field (table of Controls).
--- @field currentTab Control Currently visible tab.
