...
function TreeView:New(obj)
	...
	obj.root = TreeViewNode:New({
		treeview = obj,
		root = true,
		minHeight = obj.minItemHeight,
		expanded = obj.defaultExpanded,
		clickTextToToggle = obj.clickTextToToggle,
		labelFontsize = obj.labelFontsize,
		objectOverrideFont = obj.objectOverrideFont,
	})
	if nodes then
