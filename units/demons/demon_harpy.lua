return lowerkeys({
	demon_chiropter = {
		name = [[Harpy]],
		description = [[These odd demons are a bit standoffish, but hey, they can fly, and that's invaluable in these circumstances. Believe it or not, they are the same species as the Sphinx, just in a different form.]],
