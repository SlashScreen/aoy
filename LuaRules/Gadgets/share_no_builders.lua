...
local function PrintState()
	Spring.Echo("sharing buildersunits is " .. (unitShare and "enabled" or "disabled"))
	Spring.Echo("sharing resources is " .. (resShare and "enabled" or "disabled"))
	Spring.Echo("sharing units with enemies is " .. (unitShare and unitShareEnemy and "enabled" or "disabled"))
	Spring.Echo("sharing resources with enemies is " .. (resShare and resShareEnemy and "enabled" or "disabled"))
	return true
end
...
local function TeamHasBuilder(teamID) end
