...
if gadgetHandler:IsSyncedCode() then
	...
	local function ___UnitCreated(_asa_, unitID)
		SetUnitLuaDraw(unitID, true)
	end
	local function ___UnitDestroyed(_asa_, unitID)
		SetUnitLuaDraw(unitID, false)
	end
	local function ___FeatureCreated(_asa_, featureID)
		SetFeatureLuaDraw(featureID, true)
	end
	local function ___FeatureDestroyed(_asa_, featureID)
		SetFeatureLuaDraw(featureID, false)
	end
